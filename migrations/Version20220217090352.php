 ...
 */
final class Version20220217090352 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE producto CHANGE esta_alquilado esta_alquilado TINYINT(1) NOT NULL');
    }
