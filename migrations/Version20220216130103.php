 ...
 */
final class Version20220216130103 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE producto ADD tipo_producto VARCHAR(50) NOT NULL');
    }
