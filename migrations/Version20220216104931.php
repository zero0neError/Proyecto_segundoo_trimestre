 ...
 */
final class Version20220216104931 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tramo CHANGE factor_reductor factor_reductor INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tramo CHANGE factor_reductor factor_reductor DOUBLE PRECISION NOT NULL');
