 ...
 */
final class Version20220217072024 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tipo_producto (id INT AUTO_INCREMENT NOT NULL, nombre_id INT NOT NULL, UNIQUE INDEX UNIQ_717E5CDCC2D4D747 (nombre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
